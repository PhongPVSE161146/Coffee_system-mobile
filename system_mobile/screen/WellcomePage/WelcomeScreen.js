...
export default function WelcomeScreen({ navigation }) {
  return (
    <View style={styles.container}>
      <Image source={{ uri: "https://source.unsplash.com/400x300/?food" }} style={styles.image} />
      <Text style={styles.title}>Welcome to <Text style={styles.brand}>KOHI COFEE</Text></Text>
